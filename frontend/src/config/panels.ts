...
const InsurancePanels: PanelRegistryEntry[] = [
  ...
  {
    id: 'insurance-risk-detail',
    title: 'Risk Assessment Detail',
    subtitle: 'Full Monte Carlo risk analysis with radar, VaR, and revenue fan',
    category: 'insurance' as PanelCategory,
    component: lazy(() => import('../components/panels/insurance/RiskDetailPanel')),
  ...
  {
    id: 'insurance-stress-test',
    title: 'Stress Test Scenarios',
    subtitle: 'Scenario analysis with preset and custom stress tests',
    category: 'insurance' as PanelCategory,
    component: lazy(() => import('../components/panels/insurance/StressTestPanel')),
    defaultSize: { cols: 2, rows: 2 },
    phase: 9,
    status: 'active',
    icon: '⚡',
  },
  {
    ...
    subtitle: 'Bitcoin network stats, difficulty adjustment, and efficiency distribution',
    category: 'insurance' as PanelCategory,
    component: lazy(() => import('../components/charts/NetworkContextWidget')),
    defaultSize: { cols: 2, rows: 1 },
    phase: 9,
    status: 'active',
    icon: '🌐',
